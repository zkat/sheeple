...
*** FIND-PROTO
    Syntax:
    find-proto name &optional (errorp t) => sheep
    ...
    Examples:
      ...
      (find-proto 'test-proto) => #<Sheep AKA: TEST-PROTO #x14F31536>
...
*** #@
    ...
    Description:
    #@ is a reader macro that expands into find-proto.

    Examples:
    
       (defproto test-proto () ()) => #<Sheep AKA: TEST-PROTO #x14F31536>
       #@test-proto => #<Sheep AKA: TEST-PROTO #x14F31536>
...
**** Huge example
     This example illustrates usage of sheeple and replies:
        ...
        (defreply do-it ((something #@sheep1)) ;a convenient way of saying (find-proto 'sheep1)
...
*** CLOS (semi-)compatibility
    For the time being, CLOS objects and CLOS-defined types are boxed as #@builtin, not as
    autoboxed versions of the classes/objects.
*** Message definition
