...
(test (std-sheep-accessors
  ...
  (is (eq (setf (svref (cdr sheep) 2) (gensym)) (sheep-property-metasheep sheep)))
...
(test (sheep-property-metasheep :fixture allocate-std-sheep)
  (is (eql nil (sheep-property-metasheep sheep)))
  (is (equal '(foo) (setf (sheep-property-metasheep sheep) '(foo))))
  (is (equal '(foo) (sheep-property-metasheep sheep)))
  (is (equal '(bar foo) (push 'bar (sheep-property-metasheep sheep))))
  (is (equal '(bar foo) (sheep-property-metasheep sheep))))
