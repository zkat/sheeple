...
*** DONE (Re-)implement property objects, allow them to be lockable
*** DONE Forgot MITOSIS >_>
    lol, no I didn't -- but it needed to be fixed anyway
*** TODO Is a :copy-on-clone option for individual properties better than :cloneform for most purposes?
*** TODO Finalize everything when all else is done.
** TODO Fucking get rid of all these optimization declarations.
