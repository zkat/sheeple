...
** TODO [#B] Cache message dispatch
   ...
   but it should definitely be implemented and *ready* by the time 3.1 is tagged -- zkat
* TODO 3.0
...
*** DONE Improve the whole add-property interface.
    ...
    defproperty macro?
    UPDATE: I think the new interface for adding properties is pretty acceptable --zkat
