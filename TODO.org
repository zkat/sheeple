...
** TODO Cache message dispatch
   ...
   but it should definitely be implemented and *ready* by the time 3.0.1 is tagged -- sykopomp
...
** TODO API
   ...
   It might be a good idea to only provide MAKE-OBJECT, and get rid of SPAWN.
** TODO Implement maps
