...
** TODO Finalize API
   No (significant) changes allowed to API until 2.0
* TODO 0.95
...
** TODO Significantly stabilize API
** TODO Fix as many bugs as (in)humanly possible
* TODO 0.9
...
** DONE More optimization
   ...
   UPDATE: No more significant optimization until after 1.0. At this point, I need to write actual
   apps and see where the performance bottlenecks are.
