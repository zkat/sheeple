...
** TODO Finalize 1.0 API. Make sure everything I want/need is there
   API should not change until 2.0, so whatever makes it into this one is staying.
* TODO 0.95
...
** TODO Do some testing on sheeple, write some more tests
* TODO 0.9
...
** TODO More optimization
   ...
   Update: Sped up (setf property-value) a bit, but I have to make a decision about this...
* DONE 0.8
