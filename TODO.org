...
* TODO 3.0
  ...
  now.  It's also mainly an invitation for you, sykopomp, to flesh out any
...
*** TODO Improve the whole add-property interface.
    ...
    defproperty macro?
*** TODO Implement a property MOP
    This'll probably need a bit of shuffling around, but it should be done after the 
    basics are fully reimplemented.
