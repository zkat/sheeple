...
*** TODO DEFCLONE
    ...
    are still nice.
*** TODO DEFSHEEP->DEFPROTO
    Time to get a bit more serious. DEFPROTO is a much clearer name.
*** TODO Mitosis->copy-sheep
    Also, get it working properly.
*** TODO defbuzzword -> defmessage
    Rename this thing. It really doesn't have to be silly.
*** TODO defmessage -> defreply
    I think I could get used to this naming scheme instead.
*** TODO Fleeced Wolf -> Boxed built-in
*** TODO =white-fang= -> boxed-object
*** TODO Fleecing -> autoboxing
** TODO Make psheep easier to implement
*** TODO The order in which a sheep is built needs to be planned out more carefully.
** TODO More cleanup and convenience
*** TODO Get rid of add-on-write. Require add-property.
...
*** TODO Shallow-copy/deep-copy should not be options.
...
*** TODO Completely remove cloneforms
*** TODO Make nicknames generic properties?
    Or something similar. Would be nice to have some pointer as to what type an object is.
*** TODO Put prototypes into their own namespace
