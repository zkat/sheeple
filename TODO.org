...
* TODO 3.0.2
** DONE Figure out exactly how DEFPROTO options are canonized
...
** DONE Write unit tests that confirm lambda-list congruence is correct
   The damn thing won't boot if this doesn't work. Good Enough™
** TODO Document everything in doc/sheeple.texinfo
   DEFMESSAGE/DEFREPLY are really undocumented in the manual. Fix a bit.
